...
def gendata(data_path,
    ...
    fp = pre_normalization(fp) #normalizca
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='multiview_action_skeleton')
    parser.add_argument(
        '--ignored_sample_path',
        default='samples_with_missing_skeletons_ucla.txt')
    parser.add_argument('--out_folder', default='NWestern_UCLA')
